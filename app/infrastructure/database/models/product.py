...
class ProductModel(Base):
    ...
    images: Mapped[list["ProductImageModel"]] = relationship(  # type: ignore[name-defined]
        back_populates="product", cascade="all, delete-orphan"
    )
    characteristics: Mapped[list["ProductCharacteristicModel"]] = relationship(  # type: ignore[name-defined]
        back_populates="product", cascade="all, delete-orphan"
    )
